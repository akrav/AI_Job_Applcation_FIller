You are Cursor AI working in the repository:
ROOT: /Users/adam/Documents/GitHub/AI_Job_Applcation_FIller

Ticket to execute:
- TICKET_ID: {TICKET_ID}
- TICKET_TITLE: {TICKET_TITLE}
- TICKET_FILE: /Users/adam/Documents/GitHub/AI_Job_Applcation_FIller/Tickets/Sprint 1/TICKET-{TICKET_ID}.md
...
Objective:
- Implement TICKET-{TICKET_ID} fully, adhering to Best-Practices, with tests, and update all relevant docs. Pass cross-checks and (if schema changes) DB verify.
...
4) Documentation updates:
   - Update TICKET-{TICKET_ID}.md status/notes.
...
- {OPTIONAL_NOTES_OR_SPECIAL_CASES}